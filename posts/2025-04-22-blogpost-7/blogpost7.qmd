...
- Select an **allegation type** from a dropdown menu (e.g., sexual orientation, race, religion)
- View a **map** showing schools across the U.S., each represented by a **circle**
  - Circle size and color reflect the **number of allegations per 100 students**

### 🏛 State-Level Bar Chart

Users will be able to:
- Choose a **specific state**
- View a **bar chart** showing the **average rate of allegations per 100 students** in that state
- Data will be broken down by the **three main categories** (sexual orientation, race, religion)
